# Conflict assessment: PXD000561 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.200 | 0.500 | 0.286 | 0.200 | 0.500 | 0.286 |
| Technical | 0.615 | 0.800 | 0.696 | 0.615 | 0.800 | 0.696 |
| ExperimentalDesign | 0.008 | 0.038 | 0.013 | 0.008 | 0.038 | 0.013 |
...
| `comment[fraction identifier]` | ExperimentalDesign | 0.038 | 0.038 | 0.038 |
...
Metadata averages include only the 2212 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
