# Conflict assessment: PXD004242 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.250 | 0.332 | 0.285 | 0.250 | 0.332 | 0.285 |
| Technical | 0.818 | 0.818 | 0.818 | 0.818 | 0.818 | 0.818 |
| ExperimentalDesign | 0.249 | 0.623 | 0.356 | 0.249 | 0.623 | 0.356 |
...
| `comment[technical replicate]` | ExperimentalDesign | 0.247 | 0.247 | 0.247 |
...
Metadata averages include only the 1290 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
