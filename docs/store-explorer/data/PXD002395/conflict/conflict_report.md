# Conflict assessment: PXD002395 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.303 | 0.339 | 0.318 | 0.303 | 0.339 | 0.320 |
| Technical | 0.500 | 0.400 | 0.444 | 0.500 | 0.400 | 0.444 |
| ExperimentalDesign | 0.100 | 0.253 | 0.143 | 0.100 | 0.251 | 0.143 |
...
| `characteristics[sex]` | Biological | 0.818 | 0.818 | 0.818 |
...
Metadata averages include only the 198 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
