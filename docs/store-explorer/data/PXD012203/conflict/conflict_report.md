# Conflict assessment: PXD012203 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.750 | 0.500 | 0.600 | 0.750 | 0.500 | 0.600 |
| Technical | 0.308 | 0.364 | 0.333 | 0.308 | 0.364 | 0.333 |
...
| `characteristics[disease]` | Biological | 1.000 | 0.333 | 0.500 |
...
Metadata averages include only the 60 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
