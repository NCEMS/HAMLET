...
| Technical | 0.455 | 0.625 | 0.527 | 0.455 | 0.625 | 0.527 |
| ExperimentalDesign | 0.033 | 0.165 | 0.055 | 0.033 | 0.165 | 0.055 |
...
| `comment[fraction identifier]` | ExperimentalDesign | 0.165 | 0.165 | 0.165 |
...
| `comment[dissociation method]` | Technical | 0.004 | 0.004 | 0.004 |
...
Metadata averages include only the 1016 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
