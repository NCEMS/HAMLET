# Conflict assessment: PXD002086 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.333 | 0.258 | 0.290 | 0.333 | 0.256 | 0.290 |
| Technical | 0.453 | 0.829 | 0.586 | 0.453 | 0.829 | 0.586 |
| ExperimentalDesign | 0.013 | 0.065 | 0.022 | 0.013 | 0.065 | 0.022 |
...
| `comment[fraction identifier]` | ExperimentalDesign | 0.065 | 0.065 | 0.065 |
...
| `comment[dissociation method]` | Technical | 0.974 | 0.974 | 0.974 |
...
Metadata averages include only the 153 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
