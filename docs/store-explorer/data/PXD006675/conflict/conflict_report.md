# Conflict assessment: PXD006675 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.503 | 0.717 | 0.590 | 0.503 | 0.711 | 0.589 |
| Technical | 0.500 | 0.500 | 0.500 | 0.500 | 0.500 | 0.500 |
| ExperimentalDesign | 0.070 | 0.121 | 0.089 | 0.070 | 0.128 | 0.091 |
...
| `characteristics[disease]` | Biological | 0.020 | 0.020 | 0.020 |
| `characteristics[organism part]` | Biological | 1.000 | 1.000 | 1.000 |
| `characteristics[organism]` | Biological | 1.000 | 1.000 | 1.000 |
| `characteristics[sex]` | Biological | 0.998 | 0.998 | 0.998 |
| `characteristics[biological replicate]` | ExperimentalDesign | 0.241 | 0.241 | 0.241 |
| `comment[fraction identifier]` | ExperimentalDesign | 0.096 | 0.096 | 0.096 |
| `comment[technical replicate]` | ExperimentalDesign | 0.015 | 0.015 | 0.015 |
...
Metadata averages include only the 602 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
