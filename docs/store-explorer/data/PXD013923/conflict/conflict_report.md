# Conflict assessment: PXD013923 (store vs pride)
...
| Technical | 0.380 | 0.476 | 0.422 | 0.380 | 0.477 | 0.423 |
...
| `comment[modification parameters]` | Technical | 0.855 | 0.714 | 0.774 |
...
Metadata averages include only the 124 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
