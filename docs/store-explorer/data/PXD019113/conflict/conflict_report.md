# Conflict assessment: PXD019113 (store vs pride)
...
| Technical | 0.572 | 1.000 | 0.727 | 0.572 | 1.000 | 0.728 |
| ExperimentalDesign | 0.250 | 0.750 | 0.369 | 0.250 | 0.714 | 0.370 |
...
| `characteristics[biological replicate]` | ExperimentalDesign | 0.250 | 0.250 | 0.250 |
...
| `comment[modification parameters]` | Technical | 0.833 | 1.000 | 0.900 |
...
Metadata averages include only the 64 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
