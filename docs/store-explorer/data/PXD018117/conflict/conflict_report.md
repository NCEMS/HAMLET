# Conflict assessment: PXD018117 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.750 | 1.000 | 0.857 | 0.750 | 1.000 | 0.857 |
| Technical | 0.333 | 0.667 | 0.444 | 0.333 | 0.667 | 0.444 |
| ExperimentalDesign | 0.327 | 0.653 | 0.435 | 0.327 | 0.653 | 0.435 |
...
| `characteristics[biological replicate]` | ExperimentalDesign | 0.306 | 0.306 | 0.306 |
...
| `comment[modification parameters]` | Technical | 1.000 | 0.333 | 0.500 |
...
Metadata averages include only the 98 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
