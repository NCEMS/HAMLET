# Conflict assessment: PXD000652 (store vs pride)
...
| Technical | 0.622 | 0.548 | 0.582 | 0.622 | 0.548 | 0.583 |
| ExperimentalDesign | 0.204 | 0.511 | 0.292 | 0.204 | 0.511 | 0.292 |
...
| `comment[fraction identifier]` | ExperimentalDesign | 0.022 | 0.022 | 0.022 |
...
| `comment[dissociation method]` | Technical | 0.935 | 0.935 | 0.935 |
...
Metadata averages include only the 46 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
