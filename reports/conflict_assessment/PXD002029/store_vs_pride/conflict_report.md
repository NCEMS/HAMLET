# Conflict assessment: PXD002029 (store vs pride)
...
| Technical | 0.429 | 0.750 | 0.545 | 0.429 | 0.750 | 0.545 |
| ExperimentalDesign | 0.050 | 0.125 | 0.071 | 0.050 | 0.125 | 0.071 |
...
| `comment[fraction identifier]` | ExperimentalDesign | 0.250 | 0.250 | 0.250 |
...
| `comment[modification parameters]` | Technical | 1.000 | 0.600 | 0.750 |
...
Metadata averages include only the 24 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
