...
| Technical | 0.250 | 0.667 | 0.364 | 0.250 | 0.667 | 0.364 |
| ExperimentalDesign | 0.052 | 0.130 | 0.075 | 0.052 | 0.130 | 0.075 |
...
| `comment[fraction identifier]` | ExperimentalDesign | 0.261 | 0.261 | 0.261 |
...
Metadata averages include only the 23 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
