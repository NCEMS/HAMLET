# Conflict assessment: PXD006675 (store vs user)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.500 | 0.698 | 0.581 | 0.500 | 0.690 | 0.580 |
| Technical | 0.250 | 0.400 | 0.308 | 0.250 | 0.400 | 0.308 |
| ExperimentalDesign | 0.048 | 0.121 | 0.069 | 0.048 | 0.140 | 0.072 |
...
| `characteristics[biological replicate]` | ExperimentalDesign | 0.207 | 0.207 | 0.207 |
| `comment[fraction identifier]` | ExperimentalDesign | 0.034 | 0.034 | 0.034 |
...
Metadata averages include only the 29 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
