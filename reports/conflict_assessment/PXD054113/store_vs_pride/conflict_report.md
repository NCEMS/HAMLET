# Conflict assessment: PXD054113 (store vs pride)
...
Metadata averages include only the 5 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
