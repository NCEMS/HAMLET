# Conflict assessment: PXD005463 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.333 | 1.000 | 0.500 | 0.333 | 1.000 | 0.500 |
...
| `comment[modification parameters]` | Technical | 0.333 | 0.200 | 0.250 |
...
Metadata averages include only the 3 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
