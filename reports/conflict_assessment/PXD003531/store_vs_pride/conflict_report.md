# Conflict assessment: PXD003531 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.494 | 0.631 | 0.553 | 0.494 | 0.634 | 0.555 |
| Technical | 0.582 | 0.323 | 0.415 | 0.584 | 0.323 | 0.416 |
| ExperimentalDesign | 0.319 | 0.720 | 0.439 | 0.319 | 0.691 | 0.436 |
...
| `characteristics[disease]` | Biological | 0.458 | 0.458 | 0.458 |
...
| `comment[technical replicate]` | ExperimentalDesign | 0.593 | 0.593 | 0.593 |
...
| `comment[proteomics data acquisition method]` | Technical | 0.203 | 0.203 | 0.203 |
| `technology type` | Technical | 0.000 | 0.000 | 0.000 |

Metadata averages include only the 59 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
