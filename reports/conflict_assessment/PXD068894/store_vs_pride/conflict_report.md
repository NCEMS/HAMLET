# Conflict assessment: PXD068894 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.167 | 0.500 | 0.250 | 0.167 | 0.500 | 0.250 |
| Technical | 0.125 | 0.333 | 0.182 | 0.125 | 0.333 | 0.182 |
| ExperimentalDesign | 0.367 | 0.428 | 0.387 | 0.367 | 0.407 | 0.386 |
...
| `comment[technical replicate]` | ExperimentalDesign | 0.833 | 0.556 | 0.639 |
...
Metadata averages include only the 6 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
