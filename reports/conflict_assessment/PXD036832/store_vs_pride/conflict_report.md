...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.246 | 0.368 | 0.295 | 0.246 | 0.368 | 0.295 |
| Technical | 0.375 | 0.750 | 0.500 | 0.375 | 0.750 | 0.500 |
| ExperimentalDesign | 0.137 | 0.228 | 0.171 | 0.137 | 0.228 | 0.171 |
...
| `characteristics[disease]` | Biological | 0.474 | 0.474 | 0.474 |
...
| `comment[fraction identifier]` | ExperimentalDesign | 0.053 | 0.053 | 0.053 |
| `comment[technical replicate]` | ExperimentalDesign | 0.632 | 0.632 | 0.632 |
...
Metadata averages include only the 19 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
