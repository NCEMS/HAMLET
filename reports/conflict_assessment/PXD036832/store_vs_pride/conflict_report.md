# Conflict assessment: PXD036832 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.244 | 0.367 | 0.293 | 0.244 | 0.367 | 0.293 |
| Technical | 0.490 | 0.800 | 0.607 | 0.489 | 0.800 | 0.607 |
| ExperimentalDesign | 0.146 | 0.243 | 0.182 | 0.146 | 0.243 | 0.182 |
...
| `characteristics[disease]` | Biological | 0.466 | 0.466 | 0.466 |
...
| `comment[fraction identifier]` | ExperimentalDesign | 0.107 | 0.107 | 0.107 |
| `comment[technical replicate]` | ExperimentalDesign | 0.621 | 0.621 | 0.621 |
...
Metadata averages include only the 103 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
