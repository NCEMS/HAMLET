# Conflict assessment: PXD005355 (store vs pride)
...
Metadata averages include only the 195 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
