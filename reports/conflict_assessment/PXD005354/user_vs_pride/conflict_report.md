# Conflict assessment: PXD005354 (user vs pride)
...
Metadata averages include only the 1560 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
