# Conflict assessment: PXD001558 (user vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.667 | 1.000 | 0.800 | 0.667 | 1.000 | 0.800 |
...
Metadata averages include only the 41 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
