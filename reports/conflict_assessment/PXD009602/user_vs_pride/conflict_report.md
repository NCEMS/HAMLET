# Conflict assessment: PXD009602 (user vs pride)
...
| ExperimentalDesign | 1.000 | 0.500 | 0.667 | 1.000 | 0.500 | 0.667 |
...
Metadata averages include only the 528 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
