# Conflict assessment: PXD008934 (user vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.945 | 1.000 | 0.971 | 0.940 | 1.000 | 0.969 |
| Technical | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 |
| ExperimentalDesign | 0.500 | 0.333 | 0.400 | 0.500 | 0.333 | 0.400 |
...
| `characteristics[disease]` | Biological | 0.809 | 1.000 | 0.873 |
...
Metadata averages include only the 34 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
