# Conflict assessment: PXD007160 (user vs pride)
...
| ExperimentalDesign | 1.000 | 0.698 | 0.807 | 1.000 | 0.735 | 0.847 |
...
Metadata averages include only the 11 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
