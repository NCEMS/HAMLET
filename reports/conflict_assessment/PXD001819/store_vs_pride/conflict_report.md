# Conflict assessment: PXD001819 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.500 | 1.000 | 0.667 | 0.500 | 1.000 | 0.667 |
| Technical | 0.254 | 0.400 | 0.311 | 0.254 | 0.400 | 0.310 |
| ExperimentalDesign | 0.337 | 0.673 | 0.449 | 0.337 | 0.673 | 0.449 |
...
| `comment[technical replicate]` | ExperimentalDesign | 0.346 | 0.346 | 0.346 |
...
Metadata averages include only the 26 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
