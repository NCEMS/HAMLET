# Conflict assessment: PXD017201 (store vs pride)
...
| Technical | 0.545 | 0.375 | 0.444 | 0.545 | 0.375 | 0.444 |
| ExperimentalDesign | 0.003 | 0.014 | 0.005 | 0.003 | 0.014 | 0.005 |
...
| `comment[fraction identifier]` | ExperimentalDesign | 0.014 | 0.014 | 0.014 |
...
Metadata averages include only the 360 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
