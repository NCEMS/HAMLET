# Conflict assessment: PXD004684 (store vs pride)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.489 | 0.367 | 0.419 | 0.489 | 0.367 | 0.419 |
| Technical | 0.286 | 0.400 | 0.333 | 0.286 | 0.400 | 0.333 |
| ExperimentalDesign | 0.093 | 0.233 | 0.133 | 0.093 | 0.233 | 0.133 |
...
| `characteristics[disease]` | Biological | 0.467 | 0.467 | 0.467 |
...
| `comment[technical replicate]` | ExperimentalDesign | 0.467 | 0.467 | 0.467 |
...
Metadata averages include only the 15 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
