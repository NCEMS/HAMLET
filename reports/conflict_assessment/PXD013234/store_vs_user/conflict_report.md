# Conflict assessment: PXD013234 (store vs user)
...
|---|---:|---:|---:|---:|---:|---:|
| Biological | 0.392 | 0.522 | 0.448 | 0.392 | 0.522 | 0.448 |
| Technical | 0.500 | 0.666 | 0.569 | 0.500 | 0.656 | 0.567 |
...
| `characteristics[disease]` | Biological | 0.567 | 0.567 | 0.567 |
