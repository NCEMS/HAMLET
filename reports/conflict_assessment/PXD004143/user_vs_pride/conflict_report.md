# Conflict assessment: PXD004143 (user vs pride)
...
Metadata averages include only the 4 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
