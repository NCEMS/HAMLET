# Conflict assessment: PXD002870 (user vs pride)
...
Metadata averages include only the 1477 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
