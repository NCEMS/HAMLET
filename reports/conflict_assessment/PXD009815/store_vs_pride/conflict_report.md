# Conflict assessment: PXD009815 (store vs pride)
...
| Technical | 0.462 | 0.750 | 0.571 | 0.462 | 0.750 | 0.571 |
| ExperimentalDesign | 0.312 | 0.625 | 0.417 | 0.312 | 0.625 | 0.417 |
...
| `comment[technical replicate]` | ExperimentalDesign | 0.250 | 0.250 | 0.250 |
...
Metadata averages include only the 40 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
