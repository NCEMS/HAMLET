# Conflict assessment: PXD018594 (user vs pride)
...
Metadata averages include only the 20 uniquely matched files. Missing files are reported as coverage failures rather than zero-score metadata rows.
